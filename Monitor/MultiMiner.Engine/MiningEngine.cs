    ...
    public class MiningEngine
    {
        ...
        private static void RegisterBuiltInAgorithms()
        {
            ...
            */
            ...
            CoinAlgorithm algorithm = factory.RegisterAlgorithm(AlgorithmNames.Keccak, AlgorithmFullNames.Keccak, CoinAlgorithm.AlgorithmFamily.SHA3);
            algorithm.DefaultMiner = MinerNames.GatelessGate;
            algorithm.MinerArguments[MinerNames.GatelessGate] = AlgorithmParameter.AlgorithmKeccak;
            algorithm.BuiltIn = true;

            algorithm = factory.RegisterAlgorithm(AlgorithmNames.Groestl, AlgorithmFullNames.Groestl, CoinAlgorithm.AlgorithmFamily.SHA3);
            algorithm.DefaultMiner = MinerNames.GatelessGate;
            algorithm.MinerArguments[MinerNames.GatelessGate] = AlgorithmParameter.AlgorithmGroestlcoin;
            algorithm.BuiltIn = true;
            ...
            algorithm.DefaultMiner = MinerNames.GatelessGate;
            algorithm.MinerArguments[MinerNames.GatelessGate] = AlgorithmParameter.AlgorithmScryptNFactor11;
            algorithm.BuiltIn = true;
            ...
            */
            ...
            algorithm.DefaultMiner = MinerNames.GatelessGate;
            algorithm.MinerArguments[MinerNames.GatelessGate] = AlgorithmParameter.AlgorithmNeoScrypt;
            algorithm.BuiltIn = true;
            ...
            algorithm.DefaultMiner = MinerNames.GatelessGate;
            algorithm.MinerArguments[MinerNames.GatelessGate] = AlgorithmParameter.AlgorithmLyra2RE;
            algorithm.BuiltIn = true;
        }
        ...
        private static void RegisterMiners()
        {
            ...
            */
            factory.RegisterMiner(MinerNames.GatelessGate, MinerNames.GatelessGate, true);
            factory.RegisterMiner(MinerNames.SGMiner5GM, MinerNames.SGMiner5GM, true);
